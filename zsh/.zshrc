...
plugins=(git common-aliases copyfile copypath dirhistory fastfile alias-finder fzf colored-man-pages colorize command-not-found zsh-autosuggestions zsh-syntax-highlighting fast-syntax-highlighting zsh-autocomplete)
